...
$importIndividualFiles = Get-PSFConfigValue -FullName ax2012.tools.Import.IndividualFiles -Fallback $false
if ($ax2012.tools_importIndividualFiles) { $importIndividualFiles = $true }
