Describe "Invoke-AxLogicApp Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-AxLogicApp).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter Url' {
			$parameter = (Get-Command Invoke-AxLogicApp).Parameters['Url']
		...
		It 'Should have the expected parameter Email' {
			$parameter = (Get-Command Invoke-AxLogicApp).Parameters['Email']
		...
		It 'Should have the expected parameter Subject' {
			$parameter = (Get-Command Invoke-AxLogicApp).Parameters['Subject']
		...
		It 'Should have the expected parameter IncludeAll' {
			$parameter = (Get-Command Invoke-AxLogicApp).Parameters['IncludeAll']
		...
		It 'Should have the expected parameter AsJob' {
			$parameter = (Get-Command Invoke-AxLogicApp).Parameters['AsJob']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -Url -Email -Subject -IncludeAll -AsJob
		#>
	}
