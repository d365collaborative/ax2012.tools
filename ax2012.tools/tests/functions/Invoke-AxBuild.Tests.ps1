Describe "Invoke-AxBuild Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Invoke-AxBuild).ParameterSets.Name | Should -Be 'Generate'
		}
		
		It 'Should have the expected parameter BinDirectory' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['BinDirectory']
		...
		It 'Should have the expected parameter AlternativeBinPath' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['AlternativeBinPath']
			$parameter.Name | Should -Be 'AlternativeBinPath'
			$parameter.ParameterType.ToString() | Should -Be System.String
			$parameter.IsDynamic | Should -Be $False
			$parameter.ParameterSets.Keys | Should -Be '__AllParameterSets'
			$parameter.ParameterSets.Keys | Should -Contain '__AllParameterSets'
		...
		It 'Should have the expected parameter InstanceNumber' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['InstanceNumber']
		...
		It 'Should have the expected parameter DatabaseServer' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['DatabaseServer']
		...
		It 'Should have the expected parameter ModelstoreDatabase' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['ModelstoreDatabase']
		...
		It 'Should have the expected parameter Workers' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['Workers']
			$parameter.Name | Should -Be 'Workers'
		...
		It 'Should have the expected parameter OutputPath' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['OutputPath']
		...
		It 'Should have the expected parameter ShowOriginalProgress' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['ShowOriginalProgress']
		...
		It 'Should have the expected parameter OutputCommandOnly' {
			$parameter = (Get-Command Invoke-AxBuild).Parameters['OutputCommandOnly']
	...
	Describe "Testing parameterset Generate" {
		<#
		Generate -
		Generate -BinDirectory -AlternativeBinPath -InstanceNumber -DatabaseServer -ModelstoreDatabase -Workers -OutputPath -ShowOriginalProgress -OutputCommandOnly
		#>
	}
