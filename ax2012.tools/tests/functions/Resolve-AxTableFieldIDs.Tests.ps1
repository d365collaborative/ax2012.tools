Describe "Resolve-AxTableFieldIDs Unit Tests" -Tag "Unit" {
	BeforeAll {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Resolve-AxTableFieldIDs).ParameterSets.Name | Should -Be '__AllParameterSets'
		}
		
		It 'Should have the expected parameter DatabaseServer' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['DatabaseServer']
		...
		It 'Should have the expected parameter DatabaseName' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['DatabaseName']
		...
		It 'Should have the expected parameter ModelstoreDatabase' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['ModelstoreDatabase']
		...
		It 'Should have the expected parameter SqlUser' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['SqlUser']
		...
		It 'Should have the expected parameter SqlPwd' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['SqlPwd']
		...
		It 'Should have the expected parameter Force' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['Force']
		...
		It 'Should have the expected parameter OutputCommandOnly' {
			$parameter = (Get-Command Resolve-AxTableFieldIDs).Parameters['OutputCommandOnly']
	...
	Describe "Testing parameterset __AllParameterSets" {
		<#
		__AllParameterSets -
		__AllParameterSets -DatabaseServer -DatabaseName -ModelstoreDatabase -SqlUser -SqlPwd -Force -OutputCommandOnly
		#>
	}
