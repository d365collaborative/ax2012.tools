Describe "Resolve-AxTableFieldIDs Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Resolve-AxTableFieldIDs).ParameterSets.Name | Should -Be 'Generate'
		}
	...
	Describe "Testing parameterset Generate" {
		<#
		Generate -
		Generate -DatabaseServer -DatabaseName -ModelstoreDatabase -SqlUser -SqlPwd -Force -OutputCommandOnly
		#>
	}
