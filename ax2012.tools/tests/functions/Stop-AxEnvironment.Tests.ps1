Describe "Stop-AxEnvironment Unit Tests" -Tag "Unit" {
	...
	Describe "Ensuring unchanged command signature" {
		It "should have the expected parameter sets" {
			(Get-Command Stop-AxEnvironment).ParameterSets.Name | Should -Be 'Default', 'Specific'
		}
		
		It 'Should have the expected parameter ComputerName' {
			$parameter = (Get-Command Stop-AxEnvironment).Parameters['ComputerName']
		...
		It 'Should have the expected parameter All' {
			$parameter = (Get-Command Stop-AxEnvironment).Parameters['All']
		...
		It 'Should have the expected parameter Aos' {
			$parameter = (Get-Command Stop-AxEnvironment).Parameters['Aos']
		...
		It 'Should have the expected parameter ManagementReporter' {
			$parameter = (Get-Command Stop-AxEnvironment).Parameters['ManagementReporter']
		...
		It 'Should have the expected parameter DIXF' {
			$parameter = (Get-Command Stop-AxEnvironment).Parameters['DIXF']
